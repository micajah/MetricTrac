...
namespace MetricTrac.Bll
{
    public partial class ScoreCard
    {
        ...
        {
            return List(LinqMicajahDataContext.InstanceId, null, null);
        }

        static public List<Extend> List(Guid ScoreCardInstaceId)
        {
            return List(ScoreCardInstaceId, null, null);
        }

        static public List<Extend> List(DateTime? Date)
        {
            return List(LinqMicajahDataContext.InstanceId, Date, LinqMicajahDataContext.LogedUserId);
        }

        static public List<Extend> List(Guid ScoreCardInstaceId, DateTime? Date, Guid? CurrentUserId)
        {
            ...
            foreach (Extend cs in l)
                cs.MetricValue = MetricTrac.Bll.ScoreCardMetric.List(cs.ScoreCardID, Date, dc, ScoreCardInstaceId);
            return l;
        }

        static public List<Extend> ListMyDashBoard(DateTime? Date)
        {
            LinqMicajahDataContext dc = new LinqMicajahDataContext();
            ...
            r.Add(new Extend()
                    {
                        ...
                        Name = "My Dasboard",
                        MetricValue = MetricTrac.Bll.ScoreCardDashboard.List(Date)
                    }
                );
