        ...
        void InitDiagrams()
        {
            ...
            if (ScoreCardMetricID != null)
            {
                ...
                if (m != null)
                {
                    ...
                    {
                        InitGauge(dgwcCurrent, (double)m.CurrentValue, (double?)m.MinValue, (double?)m.MaxValue, (double?)m.Breakpoint1Value, (double?)m.Breakpoint2Value, MaxValue);
                    ...
                    {
                        InitGauge(dgwcPrevious, (double)m.PreviousValue, (double?)m.MinValue, (double?)m.MaxValue, (double?)m.Breakpoint1Value, (double?)m.Breakpoint2Value, MaxValue);
