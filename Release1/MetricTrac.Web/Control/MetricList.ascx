...
<telerik:RadWindowManager ID="rwmEditValue" runat="server" Modal="true" VisibleStatusbar="false" Height="525px" Width="600px" DestroyOnClose="true" style="z-index: 90000" />
<script language="javascript" type="text/javascript">    
    function openRadWindow(url) {
        var oWnd = radopen(url, "rwMetric");
        oWnd.Center();
    }
</script>
</div>
...
<tr><td>
    <mt:MTGridView runat="server" ID="cgvMetric" DataKeyNames="MetricID"
        ...
        <Columns>
            ...
            <mits:HyperLinkField Text="Edit" DataNavigateUrlFormatString="~/home/MetricEdit.aspx?MetricID={0}" DataNavigateUrlFields="MetricID" ItemStyle-CssClass="Cgv_B" />
...
<asp:LinqDataSource runat="server" ID="ldsMetric" ContextTypeName="MetricTrac.Bll.LinqMicajahDataContext" TableName="PerformanceIndicatorMetricJunc" 
    EnableDelete="true" EnableUpdate="true" EnableInsert="true" OnSelecting="ldsMetric_Selecting"/>
