...
<div id="Div1" runat="server">    
    <telerik:RadAjaxPanel runat="server" ID="rapDataCollector" LoadingPanelID="ralpDataCollector" EnableEmbeddedScripts="true" EnableAJAX="true">
        <mits:CommonGridView runat="server" ID="cgvDataRule" DataKeyNames="DataRuleID"
            ...
            <Columns>
                <mits:HyperLinkField Text="Edit" DataNavigateUrlFormatString="~/home/KPISetup/PerformanceIndicatorEdit.aspx?DataRuleID={0}" DataNavigateUrlFields="DataRuleID" ItemStyle-CssClass="Cgv_B" />
                ...
                <mits:TextField DataField="PerformanceIndicatorName" HeaderText="P. I."/>
...
<bll:BllDataSource runat="server" ID="ldsCollectorRule" EnableDelete="true" 
    ...
    ondeleting="ldsCollectorRule_Deleting" />