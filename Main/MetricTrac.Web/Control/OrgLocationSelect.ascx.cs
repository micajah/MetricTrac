...
namespace MetricTrac.Control
{
    public partial class OrgLocationSelect : System.Web.UI.UserControl, MetricTrac.Utils.IValueSelectControl
    {
        ...
        Telerik.Web.UI.RadTreeView GetTvOrgLocations()
        {
            return (Telerik.Web.UI.RadTreeView)ddlOrgLocation.Items[0].FindControl("tvOrgLocations");
        }
        ...
        public bool Enabled
        {
            get { return ddlOrgLocation.Enabled; }
            set { ddlOrgLocation.Enabled = value; }
        }

        public string DdlClientID
        {
            get { return ddlOrgLocation.ClientID; }
        }
        ...
        {
            set { ddlOrgLocation.OnClientTextChange=value; }
        }

        public string OnClientValueOrTextChanged
        {
            get;set;
        }
