...
<script type="text/javascript">
    ...
    function OnClientValueOrTextChanged(val, txt){
		<%if(OnClientValueOrTextChanged!=null){%> <%=OnClientValueOrTextChanged%>(val,txt);<%}%>
    }
    ...
    function DdlOrgLocationClientNodeClicked(tvOrgLocations, eventArgs) {
        ...
        OnClientValueOrTextChanged(ddlOrgLocationValue, ddlOrgLocationText);
    }
    function DllOrgLocationItemReqesting(ddlOrgLocation, eventArgs) {
        ...
        if (FullSelectedNode == null) {
            ...
            OnClientValueOrTextChanged(0, "");
        } else {
			var FullSelectedNodeValue = FullSelectedNode.get_value();
            ddlOrgLocation.set_value(FullSelectedNodeValue);
            OnClientValueOrTextChanged(FullSelectedNodeValue, FullSelectedNode.get_text());
        }
    }
    ...
    function DdlOrgLocationDropDownClosed(ddlOrgLocation, eventArgs) {
        ...
        <%if(OnClientDropDownClosed!=null){%><%=OnClientDropDownClosed%>(ddlOrgLocation);<%}%>
    }
