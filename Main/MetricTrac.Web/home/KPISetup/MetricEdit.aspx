...
<FooterStyle CssClass="Mf_F"></FooterStyle>
        <Fields>
            ...
            <mt:MTDatePickerField HeaderText="Collection Start Date" DataField="CollectionStartDate" Required="false" NullDisplayText="" MaxDate="01/01/2100" MinDate="01/01/2000" Type="DatePicker" DateFormat="MM/dd/yyyy" />
            <mt:MTDatePickerField HeaderText="Collection End Date" DataField="CollectionEndDate" Required="false" NullDisplayText="" MaxDate="01/01/2100" MinDate="01/01/2000" Type="DatePicker" DateFormat="MM/dd/yyyy" />
            <mits:TemplateField>
                <EditItemTemplate>
...
</td><td width="50px"></td><td valign="top"><span style="font-size:12px;font-weight:bold;">Assign Metric to Org Location(s) for Data Collection</span>
