...
namespace MetricTrac
{
    public partial class ScoreCardDashboardEdit : System.Web.UI.Page
    {
        ...
        protected void mfScoreCardDashboard_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
        {
            CorrectNullValues(e.NewValues);
        }

        protected void mfScoreCardDashboard_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
