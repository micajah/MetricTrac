...
<asp:Content ID="cntMetric" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <div runat="server">
	<telerik:RadAjaxPanel runat="server" ID="rapDasboard" LoadingPanelID="ralpDashboard" EnableEmbeddedScripts="true" EnableAJAX="false">
		<table>
			<tr>
				<td colspan="2">
					<uc:ScoreCardList runat="server" ID="scl" MyDashboardMode="true" OnSelectedIndexChanged="scl_SelectedIndexChanged" Width="1000px"/>
				</td>
			</tr>
			<tr>
				<td>
